...
const routes = [
	...
	// },
	{
		...
		children: [
			...
			{
				path: '/SystemAdministration/User/AddUser',
				component: () =>
					import('@/views/UserManagement/AddUser/index.vue')
			},
			{
			...
			},
			{
				...
				component: () =>
					import(
						'@/views/EventManagement/CreateEventSuccessful/index.vue'
					)
			},
			{
				...
				component: () =>
					import(
						'@/views/EventManagement/AddGeographtSuccessful/index.vue'
					)
			},
			{
				path: '/ElectionConfiguration/Contests',
				component: () =>
					import('@/views/EventManagement/Contests/index.vue')
			},
			{
				path: '/ElectionConfiguration/Candidates',
				component: () =>
					import('@/views/EventManagement/Cadidates/index.vue')
			},
			{
			...
			},
			{
				...
				component: () =>
					import('@/views/VoterManagement/AddVoter/index.vue')
			},
			// {
			//   path: "/BallotDesign",
