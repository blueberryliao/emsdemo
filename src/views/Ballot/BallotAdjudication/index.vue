		...
		<div class="content">
			<div class="content-left">
				<div class="info">
					...
					<div class="info-item">
						Image Scan Time:{{ info.imageScanTime }}
					</div>
				</div>
			...
			<div class="content-right">
				<div class="info">
					<div class="info-item">
						Scanned by Device:{{ info.scannedbyDevice }}
					</div>
					<div class="info-item">
...
export default {
	...
	methods: {
		...
		toSave() {
			//判断勾选数量  n个只能选小于n个
			if (
				this.currentContest.numberOfCandidates < this.checkList.length
			) {
